...
class RowXform extends BaseXform {
  ...
  prepare(model, options) {
    const styleId = options.styles ? options.styles.addStyleModel(model.style) : undefined;
    if (styleId) {
  ...
  reconcile(model, options) {
    model.style =
      model.styleId && options.styles ? options.styles.getStyleModel(model.styleId) : {};
